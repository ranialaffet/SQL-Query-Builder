...
<div class="card border-light shadow w-50" style="max-width: 40rem; min-width: 20rem;">
    <!-- Corps de la carte contenant le formulaire d'inscription -->
    <div class="card-body px-5 py-4">
        <!-- Titre de la carte pour l'inscription -->
        ...
        <form action="<?php echo base_url(); ?>signup/validation" method="post">
            ...
            <div class="form-floating mb-3">
                <input type="text" placeholder="Name" name="name" id="name" value="<?php echo set_value('name'); ?>" class="form-control" />
            ...
            <button type="submit" class="btn btn-primary btn-block mt-4 mb-4 w-100">Sign Up</button>

        </form>

        <!-- Lien pour les utilisateurs déjà inscrits -->
        <p class="text-center text-body-secondary">Already a member? <a href="<?php echo base_url() ?>login" class="link-primary" style="text-decoration: none;">Sign In</a></p>
        <br><br>
